<%-- 
    Document   : disciplina
    Created on : 3 de out de 2020, 13:35:14
    Author     : mandi
--%>
    ...
    <body>
       ...
       <table border="1">
            ...
            <tr>
                ...
                <td align="center" style="color:lightslategray;"><%= u.getName() %></td>
                <td align="center" style="color:lightslategray;"><%= u.getEmenta() %></td>
                <td align="center" style="color:lightslategray;"><%= u.getCiclo() %></td>
                <td align="center" style="color:lightslategray;"><%= u.getNota() %></td>
                <td>
                    <form>
